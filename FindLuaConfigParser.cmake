...
SET(LIBRARY LUACONFIGPARSER)
SET(LIBRARYNAME LuaConfigParser)
...
if (${LIBRARY}_INCLUDE_DIR AND ${LIBRARY}_LIBRARIES)
    ...
    set(${LIBRARY}_INCLUDE_DIR ${LIBRARY}_INCLUDE_DIR ${LUA_INCLUDE_DIR})
    set(${LIBRARY}_LIBRARIES ${LIBRARY}_LIBRARIES ${LUA_LIBRARIES})
